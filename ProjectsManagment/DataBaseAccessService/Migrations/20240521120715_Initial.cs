        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyBuyerId = table.Column<int>(type: "INTEGER", nullable: false),
                    CompanyExecutorId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_Companies_CompanyBuyerId",
                        column: x => x.CompanyBuyerId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Projects_Companies_CompanyExecutorId",
                        column: x => x.CompanyExecutorId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_CompanyBuyerId",
                table: "Projects",
                column: "CompanyBuyerId");

            migrationBuilder.CreateIndex(
                name: "IX_Projects_CompanyExecutorId",
                table: "Projects",
